               ...
               <div className="container flex flex-col justify-center min-h-0 px-4 py-5 lg:absolute lg:inset-x-0">
                   ...
                   <img className="object-cover pl-20 object-center lg:w-[10rem] w-full rounded-lg h-96" src={sir} alt="" />
                       ...
                       <div className="mt-8 lg:px-10 lg:mt-0">
                           ...
                           He is an accomplished academician with a Ph.D. in Information Technology from IIIT, Allahabad. With over 10 years of experience in academics, he has taught a wide range of subjects including Computer Networks, Operating Systems, and Data Structures. He participated in numerous national and international conferences and has guided several undergraduate projects. His research interests lie in Wireless Sensor Networks, Manifold Learning, Machine Learning, Computer Networks, and Data Structures.
                           </p>
                           ...
                           <p className="text-gray-600 dark:text-gray-300">📩 : neeraj.jain@mail.jiit.ac.in</p>
                       </div>
                   </div>
               </div>
           </div>
       ...
       <section className="bg-white dark:bg-gray-900">
           <div className="container px-6 py-10 mx-auto">
            <br/>
               ...
               <p className="max-w-3xl mx-auto my-6 text-justify text-gray-500 dark:text-gray-300">
               Our dedicated team ensures accurate and timely weather updates, utilizing cutting-edge technology and meticulous data analysis to deliver seamless experiences on our monitoring system website.
               </p>
               <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
               <a href="https://www.linkedin.com/in/kanika-choudhary-9746b9245" target="_blank" class="profile-container flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-gray-400 group hover:bg-gray-700 dark:border-gray-700 dark:hover:border-transparent">
    <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={image4} alt="Profile Image" />
    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">Kanika Choudhary</h1>
    <div class="flex mt-3 -mx-2">
        <a href="" class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" aria-label="LinkedIn">
            </a>
    </div>
</a>
...
<a href="https://www.linkedin.com/in/riya-arora-1389a622b/" target="_blank" class="profile-container flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-gray-400 group hover:bg-gray-700 dark:border-gray-700 dark:hover:border-transparent">
    <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={image1} alt="Profile Image" />
    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">Riya Arora</h1>
    <div class="flex mt-3 -mx-2">
        <a href="https://www.linkedin.com/in/riya-arora-1389a622b/" target="_blank" class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" aria-label="LinkedIn">
            </a>
    </div>
</a>
...
<a href="https://www.linkedin.com/in/khyati-dua-350b51271/" target="_blank" class="profile-container flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-gray-400 group hover:bg-gray-700 dark:border-gray-700 dark:hover:border-transparent">
    <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={image3} alt="Profile Image" />
    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">Khyati Dua</h1>
    <div class="flex mt-3 -mx-2">
        <a href="https://www.linkedin.com/in/khyati-dua-350b51271/" target="_blank" class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" aria-label="LinkedIn">
            
        </a>
    </div>
</a>

<a href="https://www.linkedin.com/in/ishhita-dhiman/" target="_blank" class="profile-container flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-gray-400 group hover:bg-gray-700 dark:border-gray-700 dark:hover:border-transparent">
    <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src={image2} alt="Profile Image" />
    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">Ishhita Dhiman</h1>
    <div class="flex mt-3 -mx-2">
        <a href="https://www.linkedin.com/in/ishhita-dhiman/" target="_blank" class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white" aria-label="LinkedIn">
            </a>
    </div>
</a>
