...
import jpvl from '../assets/images/jpvl.jpg';
import grpcompanies from '../assets/images/grpcompanies.png';
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 flex items-center">
        <section className="relative bg-cover bg-center py-32 w-full" style={{ backgroundImage: `url(${jpvl})` }}>
          ...
          <div className="container mx-auto text-left text-white relative z-10">
            <div className="flex">
              <div className="w-1/2">
                ...
                <p className="text-xl mb-11">An Indian power company, incorporated on Dec 21, 1994, that is part of India's leading Infrastructure conglomerate Jaypee Group.</p>
...
<img src={grpcompanies} style={{ width: '1550px', height: '200px'}}/>
