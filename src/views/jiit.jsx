       ...
       <>
           ...
           <div className="bg-gray-50 flex items-center">
               <section className="relative bg-cover bg-center py-32 w-full" style={{backgroundImage: `url(${image11})`}}>
                   ...
                   <div className="mx-auto text-left text-white relative z-10">
                       <div className="flex ">
                           <div className="w-1/2" style={{position: 'relative', left: '50px'}}>
                               <h1 className="text-5xl font-medium mb-6">Jaypee Institute of Information Technology, Noida</h1>
           ...
           <section className="bg-white dark:bg-gray-900">
               <div className="container px-6 py-10 mx-auto">
                 <br></br>
               <h1 className="text-2xl font-semibold text-center text-gray-800 text-3xl dark:text-white">
...
<br/>
                           <div className="flex items-center mt-6">
                               ...
                               <div className="mx-4">
                                   ...
                                   <span className="text-sm text-gray-500 dark:text-gray-300">Jaypee Institute of Information Technology,Noida</span>
                               </div>
                           </div>
                       </div>
                   </div>
     ...
     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       <div className="lg:grid lg:grid-cols-12 lg:gap-8 pt-12 lg:pt-0">
         <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
           <div className='page1' style={{marginTop:'-180px'}}>
             ...
             <div className="flex flex-col items-center justify-center">
               ...
               <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-gray-900 sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                 ...
                 <p className="text-orange-500 md:block"> Technology,Noida</p>
               </h1>
             </div>
         ...
         <div className="mt-16 ml-6 sm:mt-24 lg:mt-0 lg:col-span-5">
           ...
           <div className="mt-12 flex justify-center space-x-3">
             ...
             <span className="relative flex h-14 w-16 shrink-0 overflow-hidden rounded-full">
               <img className="aspect-square h-full w-full" alt="User 4" src="https://jaypeeu.ac.in/wp-content/uploads/2024/04/jua.jpg" />
             </span>
