   ...
   <div className="mx-2 text-center flex flex-row gap-12">
    ...
    <div className="items-center lg:flex">
        <div className="items-center lg:flex">
            ...
            <div className="flex flex-col items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2 lg:ml-20">
                <img className="w-full h-full lg:max-w-xl" src={image12} />
                <p className="text-sm text-gray-500 mt-2 italic">Reference Image: Niubol.com Automatic-Weather-Stations</p>
            </div>
        </div>
    </div>
</div>
